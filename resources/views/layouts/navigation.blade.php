            ...
            <div class="hidden sm:flex sm:items-center sm:space-x-6">
                ...
                <div x-data="{ openNotifications: false, notifications: [] }"
                    ...
                    <button @click="openNotifications = !openNotifications" class="relative">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 mt-2 text-gray-500 hover:text-gray-700"
                            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14V11c0-3.071-1.64-5.64-4.5-6.32V4a1.5 1.5 0 10-3 0v.68C7.64 5.36 6 7.929 6 11v3c0 .217-.087.423-.236.576L4.5 17h5m5 0a3 3 0 11-6 0h6z" />
                        </svg>
                    ...
                    <div x-show="openNotifications" @click.outside="openNotifications = false"
                        ...
                        <div class="p-4 text-gray-700">
                            <template x-for="notification in notifications" :key="notification.id">
                                <p class="border-b py-2" x-text="notification.message"></p>
                            </template>
                            <p x-show="notifications.length === 0" class="p-4 text-gray-500">Keine neuen Benachrichtigungen.</p>
                        </div>
                        <button @click="
                            ...
                            class="text-blue-500 hover:underline px-4 py-2">
